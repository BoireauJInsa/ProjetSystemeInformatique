...
HD_PWD='/home/tgauther/Bureau/COMPTEUR/COMPTEUR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log compteur_8_bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source compteur_8_bits.tcl
