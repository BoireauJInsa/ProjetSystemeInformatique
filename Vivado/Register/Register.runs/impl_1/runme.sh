...
HD_PWD='/home/tgauther/Bureau/4A/Projet Systeme Informatique/Register/Register.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Registre.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Registre.tcl -notrace
