...
HD_PWD='/home/tgauther/Bureau/4A/Projet Systeme Informatique/Register/Register.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Registre.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Registre.tcl
